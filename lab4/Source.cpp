/*
 1. Выполнить анализ задания на сквозную лабораторную работу с точки зре-
ния ее декомпозиции для кластерной системы.
Описать:
 распределение частей задачи по отдельным узлам;
 соответствующее распределение данных между узлами.
2. Проанализировать и описать процессы обмена, которые будут происходить
 на этапе, предшествующем началу вычислений;
 в ходе вычислений;
 по завершению вычислений.
3. Определить, какие операции обмена (групповые, точка-точка) наиболее
подходят для каждого этапа выполнения программы.
4. Описать в промежуточном отчете; обсудить с преподавателем.
5. Реализовать модель взаимодействия процессов, описанную в задании c
применением коллективных операций обмена.
Вместо вычислительной части программы использовать программы-«заглушки».
Для подтверждения правильности передачи данных процессы должны вы-
полнять вывод переданных/принятых данных на экран в читаемом виде.
6. Продемонстрировать работу программы
 */
